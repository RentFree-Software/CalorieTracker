...
const emit = defineEmits(['close', 'delete-entry']);
...
function handleDeleteSelected() {
  ...
  const confirmed = window.confirm(`Delete tracking data for ${formatDate(selectedEntry.value.date)}?`);
  if (!confirmed) {
    return;
  }

  emit('delete-entry', selectedEntry.value.date);
  selectedDate.value = null;
}
        ...
        <section v-if="selectedEntry" class="details-section" aria-labelledby="details-heading">
          <div class="details-header">
            ...
            <div class="details-actions">
              ...
              <button class="delete-entry-btn" @click="handleDeleteSelected" aria-label="Delete selected tracking entry">Delete</button>
            </div>
          </div>
